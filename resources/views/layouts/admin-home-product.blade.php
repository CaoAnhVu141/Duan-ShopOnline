...
<head>
    ...
    <link rel="stylesheet" type="image/x-icon" href="{{asset('img/favicon.ico')}}">
                ...
                <div class="middel_inner">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4">
                            <div class="cart_area">
                                <div class="cart_link">
                                    <a href="{{ route('carts') }}"><i class="fa fa-shopping-basket"></i>2 item(s)</a>
                                    <!--mini cart-->
                                     <div class="mini_cart">
                                        <div class="cart_item top">
                                       <div class="cart_img">
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="slider_content content_one">
                            {{-- {{asset('img/slider/content3.png')}} --}}
                            <img src="{{asset('image/content3.jpg')}}" alt="">
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="slider_content content_two">
                            <img src="{{asset('image/content4.jpg')}}" alt="">
                            <p>the wooboom clothing summer collection is back at half price</p>
                            <a href="shop.html">Discover Now</a>
                        </div>    
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="slider_content content_three">
                            <img src="{{asset('image/content5.jpg')}}" alt="">
                            <p>the wooboom clothing summer collection is back at half price</p>
                            <a href="shop.html">Discover Now</a>
                        </div>    
                    </div>
