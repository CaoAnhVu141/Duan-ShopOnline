            ...
            <div class="row">
                <div class="col-lg-5 col-md-5">
                   <div class="product-details-tab">
                        ...
                        <div id="img-1" class="zoomWrapper single-zoom">
                            <a href="#">
                                <img id="zoom1" src="{{ url($productdetail->image) }}" data-zoom-image="{{ url($productdetail->image) }}" alt="big-1">
                            </a>
                        </div>
                        ...
                        <div class="single-zoom-thumb">
                            <ul class="s-tab-zoom owl-carousel single-product-active" id="gallery_01">
                                <li>
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="{{ url($productdetail->image) }}" data-zoom-image="{{ url($productdetail->image) }}">
                                        <img src="{{ url($productdetail->image) }}" alt="zo-th-1"/>
                                    </a>
                ...
                <div class="col-lg-7 col-md-7">
                    <div class="product_d_right">
                       <form action="{{ route('add.cart',$productdetail->id) }}" method="GET">
                           {{--  --}}
                            ...
                            <div class="product_price">
                                <span class="current_price">{{ $productdetail->price }} vnd</span>
                            </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="info" role="tabpanel" >
                                <div class="product_info_content">
                                    <p>{{ $productdetail->detailproductdescription }}</p>
                                </div>    
                            </div>
